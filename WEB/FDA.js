...
function displayItems(){
    ...
    riceData.map(item=>{
        ...
        itemPrice.innerText= 'Price : Ghc ' + item.price;
...
function totalAmount(){
    ...
    document.getElementById('total-price').innerText= 'Total Price : Ghc ' + sum;
    document.getElementById('m-total-amount').innerText= 'Total Price : Ghc ' + sum;
}
